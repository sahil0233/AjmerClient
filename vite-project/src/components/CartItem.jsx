...
const CartItem = (props) => {
  ...
  return (
        <div> 
                <div className="h-32 grid grid-cols-8 mb-6 rounded-lg border px-2">
                    <img src={props.product.productImage} alt="product-image" className="col-span-1 box-border h-full p-2 rounded-lg sm:w-40" />
                    <div className="col-span-7 grid grid-cols-7 sm:mx-4  sm:w-full sm:justify-between">
                        <div className="mt-5 sm:mt-0 flex flex-col col-span-3 justify-center">
                        ...
                        <h2 className='text-xl text-black font-medium flex justify-center items-center'>₹{props.product.discountPrice}</h2>
                        <h2 className='text-xl text-green-600 font-medium flex justify-center items-center'>₹{props.product.price- props.product.discountPrice}</h2>
